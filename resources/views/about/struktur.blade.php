                  ...
                  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                      <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-white md:ms-2 dark:text-white ">Tentang Kami</a>
                      </div>
                    </li>
                    <li aria-current="page">
                      <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-whitblacke md:ms-2 dark:text-white">Struktur Organisasi</span>
                      </div>
                    </li>
                  </ol>
                </nav>

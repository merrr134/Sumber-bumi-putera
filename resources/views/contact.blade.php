...
@section('content')
<section class="relative bg-cover bg-center text-white flex items-center justify-center bg-primary-dark min-h-[80vh] fade-in-section" style="background-image: url('{{ asset('images/struktur-bg.jpg') }}');">
    <!-- Overlay -->
    ...
    <div class="relative z-10 w-full">
        <div class="container mx-auto text-start px-8 md:px-16 lg:px-36">
            <h1 class="text-3xl md:text-5xl font-bold mb-4 italic fade-in">KONTAK</h1>
        </div>

        <nav class="flex lg:px-36 px-8 fade-in" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a href="#" class="inline-flex items-center text-sm font-medium text-white dark:text-white ">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-white md:ms-2 dark:text-white ">Kontak</a>
                    </div>
                </li>
...
<div class="relative z-20 max-w-screen-xl mx-auto bg-white mb-36 -mt-36 rounded-lg scale-up">
    <div class="container mx-auto px-4 lg:px-0">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Bagian Map -->
            <div class="w-full fade-in scale-up">
                <iframe 
            ...
            <div class="p-6 rounded-lg fade-in scale-up">
